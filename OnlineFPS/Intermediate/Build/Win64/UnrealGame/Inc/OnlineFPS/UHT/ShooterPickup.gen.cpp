...
ONLINEFPS_API UClass* Z_Construct_UClass_AShooterPickup();
ONLINEFPS_API UClass* Z_Construct_UClass_AShooterPickup_NoRegister();
ONLINEFPS_API UClass* Z_Construct_UClass_AShooterWeapon_NoRegister();
ONLINEFPS_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponTableRow();
...
class UScriptStruct* FWeaponTableRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FWeaponTableRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponTableRow, (UObject*)Z_Construct_UPackage__Script_OnlineFPS(), TEXT("WeaponTableRow"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_OnlineFPS_Source_OnlineFPS_Variant_Shooter_Weapons_ShooterPickup_h__Script_OnlineFPS_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponTableRow::StaticStruct, Z_Construct_UScriptStruct_FWeaponTableRow_Statics::NewStructOps, TEXT("WeaponTableRow"), &Z_Registration_Info_UScriptStruct_FWeaponTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponTableRow), 1464803028U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterPickup, AShooterPickup::StaticClass, TEXT("AShooterPickup"), &Z_Registration_Info_UClass_AShooterPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterPickup), 1057954793U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OnlineFPS_Source_OnlineFPS_Variant_Shooter_Weapons_ShooterPickup_h__Script_OnlineFPS_2158779838(TEXT("/Script/OnlineFPS"),
	Z_CompiledInDeferFile_FID_OnlineFPS_Source_OnlineFPS_Variant_Shooter_Weapons_ShooterPickup_h__Script_OnlineFPS_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OnlineFPS_Source_OnlineFPS_Variant_Shooter_Weapons_ShooterPickup_h__Script_OnlineFPS_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_OnlineFPS_Source_OnlineFPS_Variant_Shooter_Weapons_ShooterPickup_h__Script_OnlineFPS_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OnlineFPS_Source_OnlineFPS_Variant_Shooter_Weapons_ShooterPickup_h__Script_OnlineFPS_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
